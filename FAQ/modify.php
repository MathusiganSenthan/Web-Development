...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>";
        echo "<a href='http://localhost/FAQ/edit.php?id=" . $row["id"] . "'>Edit</a> | ";
        echo "<a href='http://localhost/FAQ/delete.php?id=" . $row["id"] . "' onclick='return confirm(\"Are you sure you want to delete this quation details details?\")'>Delete</a>";
        echo "</td>";
        echo "</tr>";
    }
